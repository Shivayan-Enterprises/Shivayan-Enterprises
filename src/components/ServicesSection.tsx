  ...
  return (
    <div className="glass-card rounded-xl overflow-hidden group">
      <div className="p-6 md:p-8">
        ...
        <p className="text-magic-light/70 mb-5">{description}</p>
        <Link to={link} className="inline-flex items-center text-magic-light font-medium">
    ...
    <section ref={ref} className="py-20 md:py-28 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 md:mb-20">
          ...
          <p className="text-magic-light/80 text-lg max-w-2xl mx-auto">
